...
def custom_forbid(G, G_D, s, n):
    for i in range(len(n.G)): # Setup for G_48 with abstraction
        # Forbidden finger combinations
        s.add( And( Not(G_D[i] == 4095)))

        # Forbidden chord combinations
        s.add( And( Not(G[i] == 82), Not(G[i] == 162), Not(G[i] == 290), Not(G[i] == 98), Not(G[i] == 138), Not(G[i] == 266), Not(G[i] == 74), Not(G[i] == 2066), Not(G[i] == 1058), Not(G[i] == 546), Not(G[i] == 2082), Not(G[i] == 1034), Not(G[i] == 522), Not(G[i] == 2058), Not(G[i] == 1090), Not(G[i] == 642), Not(G[i] == 770), Not(G[i] == 578), Not(G[i] == 2178), Not(G[i] == 2306), Not(G[i] == 2114), Not(G[i] == 656), Not(G[i] == 1104), Not(G[i] == 784), Not(G[i] == 592), Not(G[i] == 2192), Not(G[i] == 2320), Not(G[i] == 2128), Not(G[i] == 1184), Not(G[i] == 1312), Not(G[i] == 1120), Not(G[i] == 672), Not(G[i] == 2208), Not(G[i] == 800), Not(G[i] == 608), Not(G[i] == 2336), Not(G[i] == 2144), Not(G[i] == 1160), Not(G[i] == 1288), Not(G[i] == 1096), Not(G[i] == 648), Not(G[i] == 2184), Not(G[i] == 776), Not(G[i] == 584), Not(G[i] == 2312), Not(G[i] == 2120)))

# Generated by impute_forbid.py. Hardcodes some variables based on the abstraction from the previous run.
def custom_hardcode(G, s, n): # Setup for G_48 with abstraction
...
def custom_chord_cost(raw_G_cost, G, s, n):
    for i in range(len(n.G)): # Setup for G_32 with abstraction
