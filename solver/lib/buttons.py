...
def custom_hardcode(G, s, n):
    s.add(G[n.G_index[' ']] == 1024)
    s.add(G[n.G_index['THE']] == 2)
    s.add(G[n.G_index['E']] == 32)
    s.add(G[n.G_index['T']] == 512)
    s.add(G[n.G_index['A']] == 16)
    s.add(G[n.G_index['S']] == 8)
    s.add(G[n.G_index['Y']] == 256)
    s.add(G[n.G_index['W']] == 2048)
    s.add(G[n.G_index['R']] == 130)
    s.add(G[n.G_index['OF']] == 64)
    s.add(G[n.G_index['C']] == 128)
    s.add(G[n.G_index['N']] == 1026)

# Generated by impute_forbid.py based on the abstraction from the previous run.
def custom_chord_cost(raw_G_cost, G, s, n):
    for i in range(len(n.G)):
        s.add( Or(raw_G_cost[i] == 5381, raw_G_cost[i] == 6742, raw_G_cost[i] == 9772, raw_G_cost[i] == 4651, raw_G_cost[i] == 7889, raw_G_cost[i] == 5941, raw_G_cost[i] == 8771, raw_G_cost[i] == 5370, raw_G_cost[i] == 8069, raw_G_cost[i] == 9769, raw_G_cost[i] == 7875, raw_G_cost[i] == 8768, raw_G_cost[i] == 4706, raw_G_cost[i] == 7903, raw_G_cost[i] == 9603, raw_G_cost[i] == 7045, raw_G_cost[i] == 8602, raw_G_cost[i] == 5217, raw_G_cost[i] == 8031, raw_G_cost[i] == 9731, raw_G_cost[i] == 7685, raw_G_cost[i] == 8730, raw_G_cost[i] == 5268, raw_G_cost[i] == 8043, raw_G_cost[i] == 9744, raw_G_cost[i] == 7747, raw_G_cost[i] == 8743, raw_G_cost[i] == 8029, raw_G_cost[i] == 7761, raw_G_cost[i] == 7889, raw_G_cost[i] == 4528, raw_G_cost[i] == 7859, raw_G_cost[i] == 9559, raw_G_cost[i] == 6946, raw_G_cost[i] == 8558, raw_G_cost[i] == 7845, raw_G_cost[i] == 7014, raw_G_cost[i] == 7654, raw_G_cost[i] == 5607, raw_G_cost[i] == 8355, raw_G_cost[i] == 9829, raw_G_cost[i] == 8172, raw_G_cost[i] == 8828, raw_G_cost[i] == 8352, raw_G_cost[i] == 8186, raw_G_cost[i] == 8314))
