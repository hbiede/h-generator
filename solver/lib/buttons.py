...
def custom_hardcode(G, s, n): # Setup for G_127 with abstraction
    ...
    s.add(G[n.G_index['D']] == 1026)
    s.add(G[n.G_index['IN']] == 1152)
    s.add(G[n.G_index['AND']] == 1280)
    s.add(G[n.G_index['TO']] == 1040)
    s.add(G[n.G_index['W']] == 256)
    s.add(G[n.G_index['P']] == 258)
    s.add(G[n.G_index['B']] == 66)
    s.add(G[n.G_index['F']] == 272)
    s.add(G[n.G_index['N']] == 128)
    s.add(G[n.G_index['ING']] == 136)
    s.add(G[n.G_index['BE']] == 274)
    s.add(G[n.G_index['R']] == 32)
    s.add(G[n.G_index['ED']] == 1282)
    s.add(G[n.G_index['M']] == 144)
    s.add(G[n.G_index['G']] == 10)
    s.add(G[n.G_index['AL']] == 2304)
    s.add(G[n.G_index['RE']] == 2176)
    s.add(G[n.G_index['IS']] == 1154)
    s.add(G[n.G_index['I']] == 514)
    s.add(G[n.G_index['NO']] == 2112)
    s.add(G[n.G_index['FOR']] == 1168)
    s.add(G[n.G_index['ES']] == 520)
    s.add(G[n.G_index['ON']] == 544)
    s.add(G[n.G_index['THAT']] == 1296)
    s.add(G[n.G_index['L']] == 160)
    s.add(G[n.G_index['IT']] == 578)
    s.add(G[n.G_index['AS']] == 1042)
    s.add(G[n.G_index['LE']] == 1032)
    s.add(G[n.G_index['SE']] == 2056)
    s.add(G[n.G_index['DE']] == 642)
    s.add(G[n.G_index['ST']] == 784)
    s.add(G[n.G_index['MA']] == 264)
    s.add(G[n.G_index['HA']] == 530)
    s.add(G[n.G_index['TION']] == 162)
    s.add(G[n.G_index['HE']] == 1056)
    s.add(G[n.G_index['CA']] == 656)
    s.add(G[n.G_index['SO']] == 82)
    s.add(G[n.G_index['TH']] == 34)
    s.add(G[n.G_index['WITH']] == 2082)
    s.add(G[n.G_index['CON']] == 146)
    s.add(G[n.G_index['AN']] == 2066)
    s.add(G[n.G_index['CE']] == 2080)
    s.add(G[n.G_index['WAS']] == 1090)
    s.add(G[n.G_index['ME']] == 290)
    s.add(G[n.G_index['C']] == 130)
    s.add(G[n.G_index['O']] == 2050)
    s.add(G[n.G_index['H']] == 576)
    s.add(G[n.G_index['CO']] == 2184)
    s.add(G[n.G_index['K']] == 2064)
    s.add(G[n.G_index['DI']] == 1120)
    s.add(G[n.G_index['OR']] == 2306)
    s.add(G[n.G_index['PRO']] == 2144)
    s.add(G[n.G_index['U']] == 640)
    s.add(G[n.G_index['SH']] == 1096)
    s.add(G[n.G_index['LI']] == 138)
    s.add(G[n.G_index['LL']] == 2128)
    s.add(G[n.G_index['AT']] == 770)
    s.add(G[n.G_index['VE']] == 72)
    s.add(G[n.G_index['X']] == 288)
    s.add(G[n.G_index['CH']] == 592)
    s.add(G[n.G_index['HIS']] == 2320)
    s.add(G[n.G_index['ARE']] == 98)
    s.add(G[n.G_index['COM']] == 776)
    s.add(G[n.G_index['THIS']] == 2208)
    s.add(G[n.G_index['NE']] == 584)
    s.add(G[n.G_index['LA']] == 522)
    s.add(G[n.G_index['EN']] == 2114)
    s.add(G[n.G_index['V']] == 80)
    s.add(G[n.G_index['PE']] == 1288)
    s.add(G[n.G_index['OU']] == 608)
    s.add(G[n.G_index['FROM']] == 2192)
    s.add(G[n.G_index['LO']] == 2178)
    s.add(G[n.G_index['ER']] == 1312)
    s.add(G[n.G_index['UT']] == 1058)
    s.add(G[n.G_index['HO']] == 266)
    s.add(G[n.G_index['SA']] == 800)
    s.add(G[n.G_index['Q']] == 528)
    s.add(G[n.G_index['SI']] == 546)
    s.add(G[n.G_index['MENT']] == 1034)
    s.add(G[n.G_index['TS']] == 1104)
    s.add(G[n.G_index['TER']] == 1184)
    s.add(G[n.G_index['TR']] == 1160)
    s.add(G[n.G_index['WHICH']] == 2312)
    s.add(G[n.G_index['UN']] == 2058)
    s.add(G[n.G_index['J']] == 96)
    s.add(G[n.G_index['INT']] == 74)
    s.add(G[n.G_index['TED']] == 2336)
    s.add(G[n.G_index['Z']] == 1088)
